...
class ClientPrefs {
	...
	public static var ratings:Bool = true;
	public static var uiSkin:String = 'Default';
	public static var uiCount:String = 'Default';
	public static var healthBarSkin:String = 'Default';
	public static var bfSkin:String = 'Default';
	public static var gfSkin:String = 'Default';
	...
	public static var shitMiss:Bool = true;
	public static var sushealth:Bool = false;
	...
	public static var daMenuMusic:String = 'Scooby';
	...
	public static var keyBinds:Map<String, Array<FlxKey>> = [
		...
		'note_1910' => [SPACE, NONE],
		'note_1911'	=> [N, NONE],
		'note_1912'	=> [J, NONE],
		'note_1913'	=> [K, NONE],
		'note_1914'	=> [L, NONE],
		'note_1915'	=> [SEMICOLON, NONE],
		'note_1916'	=> [U, NONE],
		'note_1917'	=> [I, NONE],
		'note_1918'	=> [O, NONE],
		'note_1919'	=> [P, NONE],
		...
		'note_219'  	=> [C, NONE],
		'note_2110' 	=> [V, NONE],
		'note_2111'	=> [SPACE, NONE],
		'note_2112'	=> [N, NONE],
		'note_2113'	=> [M, NONE],
		'note_2114'	=> [J, NONE],
		'note_2115'	=> [K, NONE],
		'note_2116'	=> [L, NONE],
		'note_2117'	=> [SEMICOLON, NONE],
		'note_2118'	=> [U, NONE],
		'note_2119'	=> [I, NONE],
		'note_2120'	=> [O, NONE],
		'note_2121'	=> [P, NONE],
	...
	public static function saveSettings() {
		...
		FlxG.save.data.ratings = ratings;
		FlxG.save.data.uiSkin = uiSkin;
		FlxG.save.data.uiCount = uiCount;
		FlxG.save.data.healthBarSkin = healthBarSkin;
		...
		FlxG.save.data.shitMiss = shitMiss;
		FlxG.save.data.sushealth = sushealth;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.ratings != null) {
			ratings = FlxG.save.data.ratings;
		}
		if(FlxG.save.data.uiSkin != null) {
			uiSkin = FlxG.save.data.uiSkin;
		}
		if(FlxG.save.data.uiCount != null) {
			uiCount = FlxG.save.data.uiCount;
		}
		if(FlxG.save.data.healthBarSkin != null) {
			healthBarSkin = FlxG.save.data.healthBarSkin;
		}
		...
		if(FlxG.save.data.shitMiss != null) {
			shitMiss = FlxG.save.data.shitMiss;
		}
		if(FlxG.save.data.sushealth != null) {
			sushealth = FlxG.save.data.sushealth;
		}
