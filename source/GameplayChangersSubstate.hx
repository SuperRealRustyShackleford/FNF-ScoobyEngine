...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		...
		option.minValue = 0.000001;
		option.maxValue = 1000000;
		option.changeValue = 0.05;
		option.displayFormat = '%vX';
		option.decimals = 2;
		optionsArray.push(option);
		...
		var option:GameplayOption = new GameplayOption('Opponent Drain', 'oppdrain', 'bool', false);
		optionsArray.push(option);

		var option:GameplayOption = new GameplayOption('Instakill on Miss', 'instakill', 'bool', false);
		optionsArray.push(option);

		var option:GameplayOption = new GameplayOption('No Death', 'practice', 'bool', false);
		optionsArray.push(option);
