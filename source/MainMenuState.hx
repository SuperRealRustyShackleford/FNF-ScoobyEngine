...
class MainMenuState extends MusicBeatState
{
	...
	public static var scoobyDooVersion:String = '1.1.2'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var texts:Array<String> = [
			"Friday Night Funkin' " + Application.current.meta.get('version'),
			"Psych Engine " + psychEngineVersion,
			"Psych Engine Extra Keys " + extraKeysVersion,
			"Scooby Engine " + scoobyDooVersion,
		];
