...
class CharacterEditorState extends MusicBeatState
{
	...
	override function create()
	{
		...
		|| sys.FileSystem.exists('mods/images/healthBarSkins/' + ClientPrefs.healthBarSkin + '.png')) {
			healthBarBG = new FlxSprite(30, FlxG.height - 75).loadGraphic(Paths.image('healthBarSkins/' + ClientPrefs.healthBarSkin));
		} else {
			healthBarBG = new FlxSprite(30, FlxG.height - 75).loadGraphic(Paths.image('healthBarSkins/Default'));
		}
